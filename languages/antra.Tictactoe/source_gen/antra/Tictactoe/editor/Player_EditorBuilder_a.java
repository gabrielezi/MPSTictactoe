...
/*package*/ class Player_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "player type: ");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.player_X_or_O$8I_T;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("<no player_X_or_O>");
      editorCell.setCellId("property_player_X_or_O");
